...
const clientRedirectUrls = createClientRedirectUrls(applications);

// Конфигурация OIDC Provider
const configuration = createProviderConfiguration(PORT, users, applications, userAppRoles);
